            	...
            	<div class="row-fluid">
	                ...
	                <div class="widget red">
	                    <div class="widget-title">
	                        <h4><i class="icon-reorder"></i> 管理员审批</h4>
	                            <span class="tools">
	                            ...
	                            <s:iterator  value="taskList" var="task">
	                            	<tr class="odd gradeX">
		                                ...
		                                <td class="center hidden-phone">
		                                	<a href="adminApprovalTaskPro.action?taskId=<s:property value="#task.id"/>">批准</a>
		                                	<a href="adminDisapprovalTaskPro.action?taskId=<s:property value="#task.id"/>">不批准</a>
		                                </td>
	                            	</tr>
	                            </s:iterator>
	                            </tbody>
